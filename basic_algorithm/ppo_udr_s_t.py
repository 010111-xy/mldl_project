...
def main():
  # writer = SummaryWriter('basic_algorithm/tensor_board/source_target2')
  ...
  print(f'Source -> Target Mean Reward: {mean_reward}, Std Reward: {std_reward}')
  #model.save("basic_algorithm/model/ppo_udr2.zip")
  #writer.close()
