...
def main():
  #writer = SummaryWriter('basic_algorithm/tensor_board/target_target2')
  ...
  source_vec_env = make_vec_env('CustomHopper-target-v0', n_envs=4, monitor_dir="./logs/")
  ...
  #   episode_reward, _ = evaluate_policy(model, target_env, n_eval_episodes=1, return_episode_rewards=True)
  ...
  print(f'Target -> Target Mean Reward: {mean_reward}, Std Reward: {std_reward}')

  #model.save("basic_algorithm/model/ppo_udr3.zip")
  #writer.close()
